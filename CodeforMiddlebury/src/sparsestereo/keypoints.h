...
vector<KeyPoint> getKeyPoints(Mat image /*#*/, Mat& labels /*#*/, Mat& mask /*#*/, int lexer, Ptr<SuperpixelSEEDS>& seeds)
{
       ...
       // cout << "SuperPixel and label and mask computation " << elapsed.total_microseconds()/1.0e6 << "s" << endl;
        ...
        // imwrite("/home/piyush/Downloads/original exFast/Image outputs/SuperPixelOutput/Shelves.png", result, compression_params);
        

        // Mat edges;
        // Canny( frame,edges, 80, 100,3 );
        ...
        // imwrite("/home/piyush/Downloads/original exFast/Image outputs/Canny.png", edges, compression_params);
        ...
        // compression_params.push_back(CV_IMWRITE_PNG_COMPRESSION);
        // compression_params.push_back(9);    
        // imwrite("/home/piyush/Downloads/original exFast/SuperPixelOutput/teddy.png", result, compression_params);
